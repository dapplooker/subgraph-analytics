...
export class abi__getEscapeHatchStatusResult {
  value0: boolean;
  value1: BigInt;
...
export class abi__getSupportedAssetsResult {
...
export class abi__getSupportedBridgesResult {
  value0: Array<Address>;
  value1: Array<BigInt>;
...
export class abi__pendingDefiInteractionsResult {
  value0: BigInt;
  value1: BigInt;
...
export class abi extends ethereum.SmartContract {
  ...
  getEscapeHatchStatus(): abi__getEscapeHatchStatusResult {
    let result = super.call(
    ...
    return new abi__getEscapeHatchStatusResult(
      result[0].toBoolean(),
      result[1].toBigInt()
    );
  }
  ...
  try_getEscapeHatchStatus(): ethereum.CallResult<
    abi__getEscapeHatchStatusResult
  > {
    let result = super.tryCall(
      "getEscapeHatchStatus",
      "getEscapeHatchStatus():(bool,uint256)",
    ...
    return ethereum.CallResult.fromValue(
      new abi__getEscapeHatchStatusResult(
        value[0].toBoolean(),
        value[1].toBigInt()
      )
    );
  ...
  getSupportedAssets(): abi__getSupportedAssetsResult {
    let result = super.call(
      "getSupportedAssets",
    ...
    return new abi__getSupportedAssetsResult(
      result[0].toAddressArray(),
      result[1].toBigIntArray()
    );
  }

  try_getSupportedAssets(): ethereum.CallResult<abi__getSupportedAssetsResult> {
    let result = super.tryCall(
      "getSupportedAssets",
      "getSupportedAssets():(address[],uint256[])",
      []
    ...
    let value = result.value;
    return ethereum.CallResult.fromValue(
      new abi__getSupportedAssetsResult(
  ...
  getSupportedBridges(): abi__getSupportedBridgesResult {
    let result = super.call(
      "getSupportedBridges",
    ...
    return new abi__getSupportedBridgesResult(
      result[0].toAddressArray(),
      result[1].toBigIntArray()
    );
  }
  ...
  try_getSupportedBridges(): ethereum.CallResult<
    abi__getSupportedBridgesResult
  > {
    let result = super.tryCall(
      "getSupportedBridges",
      "getSupportedBridges():(address[],uint256[])",
    ...
    let value = result.value;
    return ethereum.CallResult.fromValue(
      new abi__getSupportedBridgesResult(
        value[0].toAddressArray(),
        value[1].toBigIntArray()
      )
    );
  ...
  pendingDefiInteractions(param0: BigInt): abi__pendingDefiInteractionsResult {
    let result = super.call(
    ...
    return new abi__pendingDefiInteractionsResult(
      result[0].toBigInt(),
      result[1].toBigInt()
    );
  }
  ...
  try_pendingDefiInteractions(
    param0: BigInt
  ): ethereum.CallResult<abi__pendingDefiInteractionsResult> {
    let result = super.tryCall(
      "pendingDefiInteractions",
      "pendingDefiInteractions(uint256):(uint256,uint256)",
      [ethereum.Value.fromUnsignedBigInt(param0)]
    ...
    let value = result.value;
    return ethereum.CallResult.fromValue(
      new abi__pendingDefiInteractionsResult(
        value[0].toBigInt(),
        value[1].toBigInt()
      )
    );
