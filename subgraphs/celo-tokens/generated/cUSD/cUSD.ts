...
export class cUSD__checkpointsResult {
  value0: BigInt;
  value1: BigInt;
...
export class cUSD extends ethereum.SmartContract {
  static bind(address: Address): cUSD {
    return new cUSD("cUSD", address);
  }
  ...
  checkpoints(param0: Address, param1: BigInt): cUSD__checkpointsResult {
    let result = super.call(
      "checkpoints",
    ...
    return new cUSD__checkpointsResult(
      result[0].toBigInt(),
      result[1].toBigInt()
    );
  }
  ...
  try_checkpoints(
    param0: Address,
    param1: BigInt
  ): ethereum.CallResult<cUSD__checkpointsResult> {
    let result = super.tryCall(
      "checkpoints",
      "checkpoints(address,uint32):(uint32,uint96)",
      [
    ...
    return ethereum.CallResult.fromValue(
      new cUSD__checkpointsResult(value[0].toBigInt(), value[1].toBigInt())
    );
  }
