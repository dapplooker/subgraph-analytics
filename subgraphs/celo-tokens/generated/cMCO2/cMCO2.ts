...
export class cMCO2 extends ethereum.SmartContract {
  static bind(address: Address): cMCO2 {
    return new cMCO2("cMCO2", address);
  }
  ...
  authorized(): Address {
    let result = super.call("authorized", "authorized():(address)", []);

    return result[0].toAddress();
  }

  try_authorized(): ethereum.CallResult<Address> {
    let result = super.tryCall("authorized", "authorized():(address)", []);
    if (result.reverted) {
      return new ethereum.CallResult();
    }
    let value = result.value;
...
export class ConstructorCall__Inputs {
  ...
  get _authorizedAddr(): Address {
    return this._call.inputValues[2].value.toAddress();
  }

  get _onwerAddr(): Array<Address> {
