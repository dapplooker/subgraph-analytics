...
export class stCELO__checkpointsResult {
  value0: BigInt;
  value1: BigInt;
...
export class stCELO extends ethereum.SmartContract {
  static bind(address: Address): stCELO {
    return new stCELO("stCELO", address);
  }
  ...
  MAX_SUPPLY(): BigInt {
    let result = super.call("MAX_SUPPLY", "MAX_SUPPLY():(uint96)", []);

    return result[0].toBigInt();
  }

  try_MAX_SUPPLY(): ethereum.CallResult<BigInt> {
    let result = super.tryCall("MAX_SUPPLY", "MAX_SUPPLY():(uint96)", []);
    if (result.reverted) {
      return new ethereum.CallResult();
    }
    let value = result.value;
  ...
  checkpoints(param0: Address, param1: BigInt): stCELO__checkpointsResult {
    let result = super.call(
      "checkpoints",
    ...
    return new stCELO__checkpointsResult(
      result[0].toBigInt(),
      result[1].toBigInt()
    );
  }
  ...
  try_checkpoints(
    param0: Address,
    param1: BigInt
  ): ethereum.CallResult<stCELO__checkpointsResult> {
    let result = super.tryCall(
      "checkpoints",
      "checkpoints(address,uint32):(uint32,uint96)",
      [
    ...
    return ethereum.CallResult.fromValue(
      new stCELO__checkpointsResult(value[0].toBigInt(), value[1].toBigInt())
    );
  }
  ...
  try_totalVotingPower(): ethereum.CallResult<BigInt> {
    let result = super.tryCall(
      "totalVotingPower",
      "totalVotingPower():(uint96)",
      []
  ...
  votingPower(account: Address): BigInt {
    let result = super.call("votingPower", "votingPower(address):(uint96)", [
      ethereum.Value.fromAddress(account)
    ]);
  ...
  try_votingPower(account: Address): ethereum.CallResult<BigInt> {
    let result = super.tryCall("votingPower", "votingPower(address):(uint96)", [
      ethereum.Value.fromAddress(account)
    ]);
    if (result.reverted) {
      return new ethereum.CallResult();
