...
export class cEUR__checkpointsResult {
  value0: BigInt;
  value1: BigInt;
...
export class cEUR extends ethereum.SmartContract {
  static bind(address: Address): cEUR {
    return new cEUR("cEUR", address);
  }
  ...
  checkpoints(param0: Address, param1: BigInt): cEUR__checkpointsResult {
    let result = super.call(
      "checkpoints",
    ...
    return new cEUR__checkpointsResult(
      result[0].toBigInt(),
      result[1].toBigInt()
    );
  }
  ...
  try_checkpoints(
    param0: Address,
    param1: BigInt
  ): ethereum.CallResult<cEUR__checkpointsResult> {
    let result = super.tryCall(
      "checkpoints",
      "checkpoints(address,uint32):(uint32,uint96)",
      [
    ...
    return ethereum.CallResult.fromValue(
      new cEUR__checkpointsResult(value[0].toBigInt(), value[1].toBigInt())
    );
  }
