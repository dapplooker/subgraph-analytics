...
export class BorrowAllowanceDelegated extends Entity {
  ...
  save(): void {
    ...
    if (id) {
      assert(
        id.kind == ValueKind.STRING,
        `Entities of type BorrowAllowanceDelegated must have an ID of type String but the id '${id.displayData()}' is of type ${id.displayKind()}`
      );
  ...
  static load(id: string): BorrowAllowanceDelegated | null {
    return changetype<BorrowAllowanceDelegated | null>(
      store.get("BorrowAllowanceDelegated", id)
    );
  }
...
export class AToken extends Entity {
  ...
  save(): void {
    ...
    if (id) {
      assert(
        id.kind == ValueKind.STRING,
        `Entities of type AToken must have an ID of type String but the id '${id.displayData()}' is of type ${id.displayKind()}`
      );
  ...
  static load(id: string): AToken | null {
    return changetype<AToken | null>(store.get("AToken", id));
  }
...
export class SToken extends Entity {
  ...
  save(): void {
    ...
    if (id) {
      assert(
        id.kind == ValueKind.STRING,
        `Entities of type SToken must have an ID of type String but the id '${id.displayData()}' is of type ${id.displayKind()}`
      );
  ...
  static load(id: string): SToken | null {
    return changetype<SToken | null>(store.get("SToken", id));
  }
